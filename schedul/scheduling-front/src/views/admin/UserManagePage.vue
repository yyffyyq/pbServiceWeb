  ...
  <div class="user-manage-page" v-if="pageReady">
    ...
    <el-card class="table-card" shadow="never">
      ...
      >
        ...
        <el-table-column prop="userRole" label="用户角色" width="120" align="center">
          <template #default="{ row }">
        ...
        <el-table-column label="本月值班" width="110" align="center">
          <template #default="{ row }">
            <el-tag type="warning">{{ dutyCountMap[row.id]?.month || 0 }} 天</el-tag>
          </template>
        </el-table-column>
...
const dutyConfig = ref({ weekdayDutyList: [], saturdayGroup1: [], saturdayGroup2: [], monthEndDutyList: [], baseDate: null })
